            ...
            <section className="mb-8">
              <div className="md:flex md:gap-6 md:items-start">
                <div className="md:flex-1">
                  ...
                  <p className="mb-4 leading-relaxed text-foreground">
                    Строительство заняло 12 лет. Более 300 каменщиков, плотников и кузнецов трудились над созданием 
                    неприступной цитадели. Толщина стен достигала 3 метров, что делало замок практически 
                    неуязвимым для осадных орудий того времени. В подземельях были вырублены обширные склады и 
                    тайные проходы, ведущие к источнику чистой родниковой воды.
                  </p>
                  <p className="mb-4 leading-relaxed text-foreground">
                    К концу XII века замок стал одним из важнейших опорных пунктов региона. Здесь проходили 
                    рыцарские турниры, заключались торговые договоры и принимались важные политические решения. 
                    В 1189 году император Фридрих I Барбаросса лично посетил замок на пути к Третьему крестовому походу.
                  </p>
                </div>
            ...
            <section className="mb-8">
              ...
              <div className="md:flex md:gap-6 md:items-start mt-8">
                <div className="md:flex-1">
                  ...
                  <p className="mb-4 leading-relaxed text-foreground">
                    Все номера оснащены современными удобствами: отопление с терморегуляцией, Wi-Fi, 
                    мини-бар и ванные комнаты с подогревом полов. При этом сохранена историческая аутентичность: 
                    оригинальные деревянные балки XIV века, каменная кладка и витражи ручной работы.
                  </p>
                  <p className="leading-relaxed text-foreground">
                    Гости могут выбрать между номерами категории «Рыцарский», «Королевский» и «Императорский». 
                    Последний занимает целую башню с панорамным видом на горы и включает личную библиотеку 
                    с раритетными изданиями средневековой литературы.
                  </p>
                </div>
